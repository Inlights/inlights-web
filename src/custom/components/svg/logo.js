...
const SVG = ({ height = "100%", viewBox = "0 0 202 49", isDark }) => (
  <svg
    height={height}
    viewBox={viewBox}
  ...
  >
    <path
      ...
      fill={isDark ? "darkPaint0_radial" : "url(#paint0_radial)"}
    />
    <path
      ...
      fill={isDark ? "darkPaint1_radial" : "url(#paint1_radial)"}
    />
    <path
      d="M50.4095 37.2609V1.10315h5.6786V37.2609h-5.6786z"
      fill={isDark ? "darkPaint2_radial" : "url(#paint2_radial)"}
    />
    <path
      d="M68.7295 37.2609h-5.6787V10.4916h5.6787v26.7693z"
      fill={isDark ? "darkPaint3_radial" : "url(#paint3_radial)"}
    />
    <path
      ...
      fill={isDark ? "darkPaint4_radial" : "url(#paint4_radial)"}
    />
    <path
      ...
      fill={isDark ? "darkPaint5_radial" : "url(#paint5_radial)"}
    />
    <path
      ...
      fill={isDark ? "darkPaint6_radial" : "url(#paint6_radial)"}
    />
    <path
      ...
      fill={isDark ? "darkPaint7_radial" : "url(#paint7_radial)"}
    />
    <path
    ...
    <defs>
      ...
      >
        <stop
          offset=".0902158"
          sx={{ stopColor: (t) => `${t.colors.logoDark}` }}
          stopOpacity="0"
        />
        <stop
          offset=".7455"
